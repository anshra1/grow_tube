...
// 
// ignore_for_file: camel_case_types, depend_on_referenced_packages, avoid_js_rounded_ints, strict_raw_type, cascade_invocations, directives_ordering
...
// Import models from the project's source code
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    VideoModel: obx_int.EntityDefinition<VideoModel>(
      ...
      objectToFB: (VideoModel object, fb.Builder fbb) {
        ...
        final thumbnailUrlOffset = fbb.writeString(
          object.thumbnailUrl,
        );
        fbb.startTable(10);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final lastPlayedAtValue = const fb.Int64Reader()
        ...
        final addedAtParam = DateTime.fromMicrosecondsSinceEpoch(
          (const fb.Int64Reader().vTableGet(
                    buffer,
                    rootOffset,
                    18,
                    0,
    ...
    PlaylistModel: obx_int.EntityDefinition<PlaylistModel>(
      ...
      objectToFB: (PlaylistModel object, fb.Builder fbb) {
        final titleOffset = fbb.writeString(object.title);
        final youtubePlaylistIdOffset =
            object.youtubePlaylistId == null
            ? null
...
class VideoModel_ {
  ...
  static final lastWatchedPositionSeconds =
      obx.QueryIntegerProperty<VideoModel>(
...
class PlaylistModel_ {
  ...
  static final youtubePlaylistId =
      obx.QueryStringProperty<PlaylistModel>(
  ...
  static final isSystemDefault =
      obx.QueryBooleanProperty<PlaylistModel>(
...
class PlaylistVideoModel_ {
  ...
  static final youtubeId =
      obx.QueryStringProperty<PlaylistVideoModel>(
  ...
  static final durationSeconds =
      obx.QueryIntegerProperty<PlaylistVideoModel>(
  ...
  static final addedAt =
      obx.QueryDateNanoProperty<PlaylistVideoModel>(
