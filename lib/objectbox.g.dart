...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    name: 'PlaylistModel',
    lastPropertyId: const obx_int.IdUid(10, 7404170635936905599),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(9, 7052101240848382711),
        name: 'isPinned',
        type: 1,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(10, 7404170635936905599),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    PlaylistModel: obx_int.EntityDefinition<PlaylistModel>(
      ...
      objectToFB: (PlaylistModel object, fb.Builder fbb) {
        ...
        final localThumbnailPathOffset = object.localThumbnailPath == null
            ? null
            : fbb.writeString(object.localThumbnailPath!);
        fbb.startTable(11);
        fbb.addInt64(0, object.id);
        ...
        fbb.addOffset(9, localThumbnailPathOffset);
        fbb.finish(fbb.endTable());
        return object.id;
      },
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final localThumbnailPathParam = const fb.StringReader(
          asciiOptimization: true,
        ...
        final object = PlaylistModel(
          ...
          thumbnailUrl: thumbnailUrlParam,
          localThumbnailPath: localThumbnailPathParam,
...
class PlaylistModel_ {
  ...
  /// See [PlaylistModel.isPinned].
  static final isPinned = obx.QueryBooleanProperty<PlaylistModel>(
    _entities[1].properties[8],
  );

  /// See [PlaylistModel.localThumbnailPath].
  static final localThumbnailPath = obx.QueryStringProperty<PlaylistModel>(
